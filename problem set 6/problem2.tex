...
\begin{proof}[Solution]
   ...
   \begin{center}
      \feynmandiagram [inline=(a.base),medium, horizontal=a to b] {
         ...
         a -- [charged scalar, momentum'=\(p_1 + s_2\)] b,
      ...
      \feynmandiagram [inline=(b.base),medium, vertical=a to b] {
         ...
         a -- [charged scalar, momentum'=\(p_1 - s_4\)] b,
   ...
   For the process \(\Phi_1 \bar{\Phi}_2 \to S_3 S_4\) we consider the diagrams
   \begin{center}
      \feynmandiagram[inline=(b.base),medium,vertical = a to b] {
         i1 [particle = \(\Phi_1\)] -- [charged scalar, momentum=\(p_1\)] a -- [scalar, momentum'=\(s_3\)] f1 [particle = \(S_3\)],
         i2 [particle = \(\bar{\Phi}_2\)] -- [anti charged scalar, momentum=\(p_2\)] b, 
         b -- [scalar, momentum'=\(s_4\)] f2 [particle = \(S_4\)],
         a -- [charged scalar, momentum=\(p_1-s_3\)] b,
      };
      and
      \feynmandiagram[inline=(b.base),medium,vertical = a to b] {
         i1 [particle = \(\Phi_1\)] -- [charged scalar, momentum=\(p_1\)] a -- [scalar, momentum'=\(s_4\)] f1 [particle = \(S_4\)],
         i2 [particle = \(\bar{\Phi}_2\)] -- [anti charged scalar, momentum=\(p_2\)] b, 
         b -- [scalar, momentum'=\(s_3\)] f2 [particle = \(S_3\)],
         a -- [charged scalar, momentum=\(p_1-s_4\)] b,
      };,
   \end{center}
   then analogously as the previous process we obtain
   \begin{align*}
      \braket{s_3 s_4}{p_1 p_2} &= (-i \Delta)^2 \int_{\mathbb{R}^4}\frac{\dln4k}{(2\pi)^4} \frac{i (2\pi)^8 \left[\delta(p_1 - s_3 - k)\delta(k + p_2 - s_4) + \delta(p_1 - s_4 - k)\delta(k + p_2 - s_3)\right]}{Z_S Z_\Phi (k^2 - \mu^2 + i \epsilon)}\\
      &= (2\pi)^4(-i \Delta)^2 Z_S^{-1} Z_\Phi^{-1} \left[\frac{i \delta(p_1 +p_2 - s_3 - s_4)}{(p_1 - s_3)^2 - \mu^2 + i \epsilon} + \frac{i \delta(p_1 + p_2 - s_3 - s_4)}{(p_1 - s_4)^2 - \mu^2 + i \epsilon}\right]\\
                                &= \frac{-i \Delta^2 (2\pi)^4 \delta(p_1 + p_2 - s_3 - s_4)}{Z_S Z_\Phi}\left[\frac{1}{(p_1 - s_3)^2 - \mu^2 + i \epsilon} + \frac{1}{(p_1 - s_4)^2 - \mu^2 + i \epsilon}\right],
   \end{align*}
   as its lowest order matrix element.
\end{proof}
