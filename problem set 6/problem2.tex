...
\begin{proof}[Solution]
   ...
   \end{center}
   as the lowest order contribution. If it were \(\Phi_1 \bar{\Phi}_2 \to S_3 S_4 S_5\) we would get, the \(\Delta^3\) contribution from diagrams such as
   \begin{center}
      \feynmandiagram [small, vertical=c to a] {
         i1 [particle=\(\Phi_1\)] -- [charged scalar, momentum=\(p_1\)] a -- [scalar, momentum=\(s_3\)] f1 [particle=\(S_3\)],
   ...
   \end{center}
   as the lowest order contribution.
\end{proof}
